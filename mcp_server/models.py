...
class Item(BaseModel):
    acceptedPaymentMethods: Optional[str] = Field(
        None,
    ...
    additionalImageUrls: Optional[str] = Field(
        None,
    ...
    additionalShippingCostPerUnit: Optional[str] = Field(
        None,
    ...
    availabilityThreshold: Optional[int] = Field(
        None,
    ...
    availabilityThresholdType: Optional[str] = Field(
        None,
    ...
    buyingOptions: Optional[str] = Field(
        None,
    ...
    color: Optional[str] = Field(None, description='The color of the item.')
    ...
    defaultImageUrl: Optional[str] = Field(
        None,
    ...
    deliveryOptions: Optional[str] = Field(
        None,
    ...
    ecoParticipationFeeCurrency: Optional[str] = Field(
        None,
        description='The currency in which the Eco Participation Fee for the item is paid.',
    )
    ecoParticipationFeeValue: Optional[str] = Field(
        None,
    ...
    estimatedAvailableQuantity: Optional[int] = Field(
        None,
    ...
    hazmatAdditionalInformation: Optional[str] = Field(
        None,
        description='Base64 encoded additional information about the hazardous material.',
    )
    hazmatPictogramDescriptions: Optional[str] = Field(
        None,
    ...
    hazmatPictogramIds: Optional[str] = Field(
        None,
    ...
    hazmatPictogramImageUrls: Optional[str] = Field(
        None,
    ...
    hazmatSignalWord: Optional[str] = Field(
        None,
        description="The localized signal word for the hazardous material, such as 'Danger'.",
    )
    hazmatSignalWordId: Optional[str] = Field(
        None, description='The ID of the signal word for the hazardous material.'
    )
    hazmatStatementDescriptions: Optional[str] = Field(
        None,
    ...
    inferredBrand: Optional[str] = Field(
        None,
    ...
    inferredEpid: Optional[str] = Field(
        None,
    ...
    inferredGtin: Optional[str] = Field(
        None,
    ...
    inferredLocalizedAspects: Optional[str] = Field(
        None,
    ...
    inferredMpn: Optional[str] = Field(
        None,
    ...
    itemLocationCountry: Optional[str] = Field(
        None, description='The country where the item is physically located.'
    )
    ...
    lengthUnitOfMeasure: Optional[str] = Field(
        None,
    ...
    localizedAspects: Optional[str] = Field(
        None,
    ...
    originalPriceCurrency: Optional[str] = Field(
        None,
    ...
    originalPriceValue: Optional[str] = Field(
        None,
        description='The original selling price of the item. This lets you surface a strikethrough price for the item. ',
    )
    packageHeight: Optional[str] = Field(
        None, description='The height of the shipping package that contains the item.'
    )
    packageLength: Optional[str] = Field(
        None, description='The length of the shipping package that contains the item.'
    )
    packageWeight: Optional[str] = Field(
        None, description='The weight of the package that contains the item.'
    )
    packageWidth: Optional[str] = Field(
        None, description='The width of the shipping package that contains the item.'
    )
    ...
    primaryItemGroupId: Optional[str] = Field(
        None,
    ...
    primaryItemGroupType: Optional[str] = Field(
        None,
    ...
    priorityListingPayload: Optional[str] = Field(
        None,
    ...
    qualifiedPrograms: Optional[str] = Field(
        None,
    ...
    repairScore: Optional[str] = Field(
        None,
    ...
    returnMethod: Optional[str] = Field(
        None,
    ...
    returnPeriodUnit: Optional[str] = Field(
        None,
    ...
    returnPeriodValue: Optional[int] = Field(
        None,
    ...
    returnShippingCostPayer: Optional[str] = Field(
        None,
    ...
    returnsAccepted: Optional[bool] = Field(
        None, description='Indicates whether the seller accepts returns for the item.'
    )
    sellerAccountType: Optional[str] = Field(
        None,
    ...
    sellerFeedbackPercentage: Optional[str] = Field(
        None, description="The percentage of the seller's total positive feedback."
    )
    sellerFeedbackScore: Optional[str] = Field(
        None,
    ...
    sellerItemRevision: Optional[str] = Field(
        None,
    ...
    sellerTrustLevel: Optional[str] = Field(
        None,
    ...
    sellerUsername: Optional[str] = Field(
        None, description="The seller's eBay user name."
    )
    shipToExcludedRegions: Optional[str] = Field(
        None,
    ...
    shipToIncludedRegions: Optional[str] = Field(
        None,
    ...
    shippingCarrierCode: Optional[str] = Field(
        None, description='The name of the shipping provider, such as FedEx, or USPS.'
    )
    shippingCost: Optional[str] = Field(
        None,
    ...
    shippingServiceCode: Optional[str] = Field(
        None, description='The type of shipping service. For example, USPS First Class.'
    )
    shippingType: Optional[str] = Field(
        None,
        description='The type of a shipping option, such as EXPEDITED, ONE_DAY, STANDARD, ECONOMY, PICKUP, etc.',
    )
    size: Optional[str] = Field(None, description='The size of the item.')
    takeBackPolicyDescription: Optional[str] = Field(
        None,
        description='The seller-defined description of the TAKE_BACK custom policy for the item.',
    )
    takeBackPolicyLabel: Optional[str] = Field(
        None,
    ...
    tyreLabelImageUrl: Optional[str] = Field(
        None,
    ...
    weightUnitOfMeasure: Optional[str] = Field(
        None,
...
class ItemGroup(BaseModel):
    ...
    variesByLocalizedAspects: Optional[str] = Field(
        None,
...
class ItemGroupResponse(BaseModel):
    itemGroups: Optional[List[ItemGroup]] = Field(
        None,
...
class ItemPriority(BaseModel):
    changeMetadata: Optional[str] = Field(
        None,
...
class ItemPriorityResponse(BaseModel):
    itemDelta: Optional[List[ItemPriority]] = Field(
        None,
...
class ItemSnapshot(BaseModel):
    ...
    authenticityGuaranteeFeeCurrency: Optional[str] = Field(
        None,
        description='The currency used for the Authenticity Guarantee service fee.',
    )
    authenticityGuaranteeFeeValue: Optional[str] = Field(
        None,
    ...
    authenticityGuaranteeSelection: Optional[str] = Field(
        None,
    ...
    authenticityGuaranteeServiceId: Optional[str] = Field(
        None,
    ...
    couponDiscountCurrency: Optional[str] = Field(
        None, description='The currency used to specify the coupon discount value.'
    )
    couponDiscountType: Optional[str] = Field(
        None,
    ...
    couponDiscountValue: Optional[str] = Field(
        None, description='The discount amount after the coupon is applied.'
    )
    couponExpirationDate: Optional[str] = Field(
        None,
        description='The expiration date for the coupon. <br><br><b> Format: </b> UTC <code>yyyy-MM-ddThh:mm:ss.sssZ</code>',
    )
    couponMessage: Optional[str] = Field(
        None, description='A description of the coupon.'
    )
    couponRedemptionCode: Optional[str] = Field(
        None, description='The redemption code for the coupon.'
    )
    couponTermsWebUrl: Optional[str] = Field(
        None, description='The URL to the coupon terms of use.'
    )
    defaultImageUrl: Optional[str] = Field(
        None,
        description='URL to the gallery or default image of the item. The other images of the item are returned in the <b>additionalImageUrls</b> field.<br><br><b>For example</b><br><br><code>https://i.ebayimg.com/00/s/M********w/z/W********p/$_1.JPG?set_id=8********F</code>',
    ...
    itemSnapshotDate: Optional[str] = Field(
        None,
...
class ItemSnapshotResponse(BaseModel):
    items: Optional[List[ItemSnapshot]] = Field(
        None,
